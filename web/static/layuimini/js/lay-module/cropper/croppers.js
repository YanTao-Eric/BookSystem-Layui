...
layui.config({
    ...
    var html = "<link rel=\"stylesheet\" href=\"/static/cropper/cropper.css\">\n" +
        ...
        "            <label for=\"cropper_avatarImgUpload\" class=\"layui-btn layui-btn-primary layui-border-blue\">\n" +
        "                <i class=\"layui-icon\">&#xe67c;</i>选择图片\n" +
        "            </label>\n" +
        "            <input class=\"layui-upload-file\" id=\"cropper_avatarImgUpload\" type=\"file\" accept='image/*' value=\"选择图片\" name=\"file\">\n" +
        "        </div>\n" +
        // "        <div class=\"layui-form-mid layui-word-aux\">头像的尺寸限定150x150px,大小在50kb以内</div>\n" +
        "        <div class=\"layui-form-mid layui-word-aux\">以便系统显示，请将头像裁剪为1:1比例的图片</div>\n" +
        "    </div>\n" +
        ...
        "                    <button type=\"button\" class=\"layui-btn layui-icon layui-icon-left\" cropper-event=\"rotate\" data-option=\"-15\" title=\"向左旋转15°\"> 向左旋转</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn layui-icon layui-icon-right\" cropper-event=\"rotate\" data-option=\"15\" title=\"向右旋转15°\"> 向右旋转</button>\n" +
        "                </div>\n" +
                        ...
                        $.ajax({
                            ...
                            success:function(result){
                                if(result.code === 0){
                                    ...
                                    layer.closeAll('page');
                                    return done(result.data.filename);
